...
<head lang="en">
	...
	<![endif]-->
    <link rel="stylesheet" href="<?php echo base_url() ?>assest/css/separate/pages/error.min.css">
...
<div class="page-error-box">
    ...
    <a href="<?php echo base_url() ?>user/dashboard" class="btn btn-rounded">Main page</a>
</div>