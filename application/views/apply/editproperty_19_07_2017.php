		  ...
		  <div class="row">
			<div class="col-md-12">
				...
				<?php echo form_open('', array('class'=>'email','id' =>'form-signup_v2','name'=>'form-signup_v2','enctype' => 'multipart/form-data'));?>
				   ...
				   <div class="form-group">
					  <label class="form-label" for="signup_v2-name">Zip Code</label>
					  <div class="form-control-wrapper">
						  <input type="text"  id="zip_code"   name="zip_code" class="form-control" value="<?php echo $property_data['zip_code'] ; ?>" placeholder="enter zip code" required/>		
					  </div>
				   </div>
									...
									<section class="card card-default" style="border:0px solid">
										...
										<div class="form-group" style="margin: 30px 0 25px 16px;">
										   <div class='input-group date'>
											  <input id="daterange1" name="electrical_prev_date" type="text"  class="form-control datepicker" placeholder="Previous test date" value="<?php echo (isset($certifiles[0]) && !empty($certifiles[0]['certificate_date'])) ? $certifiles[0]['certificate_date'] : '' ; ?>">
										...
										<div class="form-group" style="margin: 30px 0 25px 16px;">
										  ...
										  <div class="form-group" style="margin: 30px 0 25px 16px;">
											<div class='input-group date'>
											   ...
											   <input id="file_one" type="file" name="electrical_upload_file" class="form-control">
											</div>
										</div>
											...
											<div class='input-group date'>
											  ...
											  <?php
													foreach ($electricalarray as $other_cert) {?>
														<div class="alert alert-success fade in">
															<a href="#" class="close close_other_cert" id="<?php echo $other_cert['certificate_unique_id'] ?>">&times;</a>
							...
							<div class="panel-body">
								...
								<div class="prev_detail_hide2" style="<?php echo $style; ?>">
									...
									<div class="form-group" style="margin: 15px 0 15px 16px;">
									   <div class='input-group date'>
									  <input id="daterange2" name="emergency_prev_date" type="text"  class="form-control datepicker" placeholder="Previous Test Date" value="<?php echo (isset($certifiles[1]) && !empty($certifiles[1]['certificate_date'])) ? $certifiles[1]['certificate_date'] : '' ; ?>">
									   <span class="input-group-addon">
										<i class="font-icon font-icon-calend"></i>
										</span>
									  </div>
									...
									<div class="form-group" style="margin: 15px 0 15px 16px;">
									   <div class='input-group date'>
										 <label>Upload Certificate</label>
										 <input id="file_two" type="file" name="emergency_upload_file"  class="form-control">
									   </div>
									</div>
							...
							<div class="panel-body">
								<div class="row">
									   ...
									   <!--date-img col-->
										<div class="form-group" style="margin: 15px 0 15px 16px;">
										   <div class='input-group date'>
										  <input id="daterange3" name="portable_prev_date" type="text"  class="form-control datepicker" placeholder="Previous test date" <?php echo (isset($certifiles[2]) && !empty($certifiles[2]['certificate_date'])) ? $certifiles[2]['certificate_date'] : '' ; ?>>
										   <span class="input-group-addon">
											<i class="font-icon font-icon-calend"></i>
											</span>
										  </div>
										...
										<div class="form-group" style="margin: 30px 0 25px 16px;">
										 ...
										 <div class="form-group" style="margin: 15px 0 15px 16px;">
										   <div class='input-group date'>
											 <label>Upload Certificate</label>
											 <input id="file_three" type="file" name="portable_upload_file"  class="form-control">
										   </div>
										</div>
								...
								<div class="panel-body">
									  <div class="row">
										   ...
										   <!--date-img col-->
											<div class="form-group" style="margin: 15px 0 15px 16px;">
											   <div class='input-group date'>
											  <input id="daterange4" name="fire_prev_date" type="text"  class="form-control datepicker" placeholder="Previous test date" value="<?php echo (isset($certifiles[3]) && !empty($certifiles[3]['certificate_date'])) ? $certifiles[3]['certificate_date'] : '' ; ?>">
											   <span class="input-group-addon">
												<i class="font-icon font-icon-calend"></i>
												</span>
											  </div>
											...
											<div class="form-group" style="margin: 30px 0 25px 16px;">
											 ...
											 <div class="form-group" style="margin: 15px 0 15px 16px;">
											   <div class='input-group date'>
													<label>Upload Certificate</label>
												   <input id="file_four" type="file" name="fire_upload_file"  class="form-control">
											   </div>
											</div>
								...
								<div class="panel-body">
									 <div class="row">
										   ...
										   <div class="card-block">
											 ...
											 <div class="form-group">
											   <div class='input-group date'>
											  <input id="daterange5" name="smoke_prev_date" type="text"  class="form-control datepicker" placeholder="Previous test date" value="<?php echo (isset($certifiles[4]) && !empty($certifiles[4]['certificate_date'])) ? $certifiles[4]['certificate_date'] : '' ; ?>">
											   <span class="input-group-addon">
												<i class="font-icon font-icon-calend"></i>
												</span>
											  </div>
											...
											<div class="form-group" style="margin: 30px 0 25px 0px;">
											 ...
											 <div class="form-group">
												<div class='input-group date'>
													<label>Upload Certificate</label>
												   <input id="file" type="file" name="smoke_upload_file"  class="form-control">
												</div>
											</div>
								...
								<div class="panel-body">
									 <div class="row">
										   ...
										   <!--date-img col-->
											<div class="form-group" style="margin: 15px 0 15px 16px;">
											   <div class='input-group date'>
											  <input id="daterange6" name="carbon_prev_date" type="text"  class="form-control datepicker" placeholder="Previous test date" value="<?php echo (isset($certifiles[5]) && !empty($certifiles[5]['certificate_date'])) ? $certifiles[5]['certificate_date'] : '' ; ?>">
											   <span class="input-group-addon">
												<i class="font-icon font-icon-calend"></i>
												</span>
											  </div>
											...
											<div class="form-group" style="margin: 30px 0 25px 16px;">
											 ...
											 <div class="form-group" style="margin: 15px 0 15px 16px;">
												<div class='input-group date'>
													<label>Upload Certificate</label>
													 <input id="file_six" type="file" name="carbon_upload_file"  class="form-control">		
												</div>
											</div>
								...
								<div class="panel-body">
									 <div class="row">
										   ...
										   <!--date-img col-->
											<div class="form-group" style="margin: 15px 0 15px 16px;">
											   <div class='input-group date'>
											  <input id="daterange7" name="gas_safety_prev_date" type="text"  class="form-control datepicker" placeholder="Previous test date" value="<?php echo (isset($certifiles[6]) && !empty($certifiles[6]['certificate_date'])) ?$certifiles[6]['certificate_date'] : '' ; ?>">
											   <span class="input-group-addon">
												<i class="font-icon font-icon-calend"></i>
												</span>
											  </div>
											...
											<div class="form-group" style="margin: 30px 0 25px 16px;">
											 ...
											 <div class="form-group" style="margin: 15px 0 15px 16px;">
												<div class='input-group date'>
													<label>Upload Certificate</label>
													 <input id="file_seven" type="file" name="gas_safety_upload"  class="form-control">					
												</div>
											</div>
