          ...
          <div class="row">
			  ...
			  ?>
			   <div class="prev_detail_hide1" style="<?php echo $electrical_test_style; ?>">
                      <div class="col-md-3">
                     	<a href="<?php echo base_url('jobs/view_certificate/'.$property_data['unique_id']).'/1' ?>" ><button type="button" class="btn"><span class="font-icon font-icon-eye"></span> View Certificates</button></a></div>
							        ...
							        <div class="" style="margin-left: 17px">
							         ...
							         <div class="form-group">
                                      ...
                                      <div class="form-group" style="margin: 15px 0 15px 16px;">
                                          ...
                                          <input id="daterange2" name="electrical_prev_date" type="text" class="form-control datepicker hasDatepicker" placeholder="Previous Test Date" required="required" value="<?php echo $certifiles[0]['certificate_date'] ; ?>">
                                          <input type="hidden" name="electrical_prev_date_id" value="<?php echo $certifiles[0]['certificate_id'] ; ?>">
                                          <?php } else {?>
                                          <input id="daterange2" name="electrical_prev_date" type="text" class="form-control datepicker hasDatepicker" placeholder="Previous Test Date" required="required" value="">
        ...
        <div class="panel-body">
			  ...
			  ?>
			   <div class="prev_detail_hide2" style="<?php echo $emergency_test_style; ?>">
                      <div class="col-md-3">
                     	<a href="<?php echo base_url('jobs/view_certificate/'.$property_data['unique_id']).'/2' ?>" ><button type="button" class="btn"><span class="font-icon font-icon-eye"></span> View Certificates</button></a>
                     	</div>
                     </div>
			 ...
			 $emergency_test_style='';
			  ...
			  ?>
							  ...
							  <input id="daterange3" name="emergency_prev_date" type="text" class="form-control datepicker hasDatepicker" placeholder="Previous test date" required="required" value="<?php echo $certifiles[1]['certificate_date'] ; ?>">
                              <input type="hidden" name="emergency_prev_date_id" value="<?php echo $certifiles[1]['certificate_id'] ; ?>">
                              <?php } else {?>
                              <input id="daterange3" name="emergency_prev_date" type="text" class="form-control datepicker hasDatepicker" placeholder="Previous test date" required="required" value="">
        ...
        <div class="panel-body">
			  ...
			  ?>
			   <div class="prev_detail_hide3" style="<?php echo $portable_test_test_style; ?>">
                      <div class="col-md-3">
                     	<a href="<?php echo base_url('jobs/view_certificate/'.$property_data['unique_id']).'/3' ?>" ><button type="button" class="btn"><span class="font-icon font-icon-eye"></span> View Certificates</button></a>
                     	</div>
                     </div>
			 ...
			 $portable_test_test_style='';
			  ...
			  ?>
							  ...
							  <input id="daterange3" name="portable_prev_date" type="text" class="form-control datepicker hasDatepicker" placeholder="Previous test date" required="required" value="<?php echo $certifiles[2]['certificate_date'] ; ?>">
                              <input type="hidden" name="portable_prev_date_id" value="<?php echo $certifiles[2]['certificate_id'] ; ?>">
                              <?php } else {?>
                              <input id="daterange3" name="portable_prev_date" type="text" class="form-control datepicker hasDatepicker" placeholder="Previous test date" required="required" value="">
        ...
        <div class="panel-body">
			  ...
			  ?>
			   <div class="prev_detail_hide4" style="<?php echo $fire_test_style; ?>">
                      <div class="col-md-3">
                     	<a href="<?php echo base_url('jobs/view_certificate/'.$property_data['unique_id']).'/4' ?>" ><button type="button" class="btn"><span class="font-icon font-icon-eye"></span> View Certificates</button></a>
                     	</div>
                     </div>
			 ...
			 $fire_test_style='';
			  ...
			  ?>
							  ...
							  <input id="daterange4" name="fire_prev_date" type="text" class="form-control datepicker hasDatepicker" placeholder="Previous test date" required="required" value="<?php echo $certifiles[3]['certificate_date'] ; ?>">
                              <input type="hidden" name="fire_prev_date_id" value="<?php echo $certifiles[3]['certificate_id'] ; ?>">
                              <?php } else {?>                          
                              
                              <input id="daterange4" name="fire_prev_date" type="text" class="form-control datepicker hasDatepicker" placeholder="Previous test date" required="required" value="">
           ...
           <div class="row">
			  ...
			  ?>
			   <div class="prev_detail_hide5" style="<?php echo $smoke_test_style; ?>">
                      <div class="col-md-3">
                     	<a href="<?php echo base_url('jobs/view_certificate/'.$property_data['unique_id']).'/5' ?>" ><button type="button" class="btn"><span class="font-icon font-icon-eye"></span> View Certificates</button></a>
                     	</div>
                     </div>
							        </div><!--close of md-12>-->
							        </div><!--end of row-->
			 ...
			 $smoke_test_style='';
			  ...
			  ?>
							  ...
							  <input id="daterange5" name="smoke_prev_date" type="text" class="form-control datepicker hasDatepicker" placeholder="Previous test date" required="required" value="<?php echo $certifiles[4]['certificate_date'] ; ?>">
                              <input type="hidden" name="smoke_prev_date_id" value="<?php echo $certifiles[4]['certificate_id'] ; ?>">
                              <?php } else {?>
                              <input id="daterange5" name="smoke_prev_date" type="text" class="form-control datepicker hasDatepicker" placeholder="Previous test date" required="required" value="">
           ...
           <?php 
			  ...
			  ?>
			   <div class="prev_detail_hide6" style="<?php echo $corbon_style; ?>">
                      <div class="col-md-3">
                     	<a href="<?php echo base_url('jobs/view_certificate/'.$property_data['unique_id']).'/6' ?>" ><button type="button" class="btn"><span class="font-icon font-icon-eye"></span> View Certificates</button></a>
                     	</div>
                     </div>
	        ...
	        <div class="prev_detail_hide6" style="<?php echo $corbon_style; ?>">
	         ...
	         <div class="form-group">
              ...
              <div class="form-group" style="margin: 15px 0 15px 16px;">
							  ...
							  <input id="daterange6" name="carbon_prev_date" type="text" class="form-control datepicker hasDatepicker" placeholder="Previous test date" required="required" value="<?php echo $certifiles[5]['certificate_date'] ; ?>">
                              <input type="hidden" name="carbon_prev_date_id" value="<?php echo $certifiles[5]['certificate_id'] ; ?>">
                              <?php } else {?>
                              <input id="daterange6" name="carbon_prev_date" type="text" class="form-control datepicker hasDatepicker" placeholder="Previous test date" required="required" value="">
           ...
           <?php 
			  ...
			  ?>
			   <div class="prev_detail_hide7" style="<?php echo $gas_safety_test_style; ?>">
                      <div class="col-md-3">
                     	<a href="<?php echo base_url('jobs/view_certificate/'.$property_data['unique_id']).'/7' ?>" ><button type="button" class="btn"><span class="font-icon font-icon-eye"></span> View Certificates</button></a>
                     	</div>
                     </div>
	        ...
	        <div class="" style="margin-left: 17px">
	         ...
	         <div class="form-group">
              ...
              <div class="form-group" style="margin: 15px 0 15px 16px;">
                  ...
                  <input id="daterange7" name="gas_safety_prev_date" type="text" class="form-control datepicker hasDatepicker" placeholder="Previous test date" required="required" value="<?php echo $certifiles[6]['certificate_date'] ; ?>">
                  <input type="hidden" name="gas_prev_date_id" value="<?php echo $certifiles[6]['certificate_id'] ; ?>">
                  <?php } else {?>
                  <input id="daterange7" name="gas_safety_prev_date" type="text" class="form-control datepicker hasDatepicker" placeholder="Previous test date" required="required" value="">
