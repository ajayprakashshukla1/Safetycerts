							 ...
							 <div class="panel-body">
								...
								<div class="prev_detail_hide1"  style="<?php echo $style; ?>">
									...
									<section class="card card-default" style="border:0px solid">
										 ...
										 $required = ''; }?>
										  ...
										  <div class="form-group" style="margin: 30px 0 25px 16px;">
											<div class='input-group date'>
											   ...
											   <input id="file_one" type="file" name="electrical_upload_file" class="form-control" <?php echo $required; ?> onchange="uploadcertfile(this.files[0],'electrical_upload_file','file_one')">
											</div>
										...
										<div class="form-group edited" style="margin: 30px 0 25px 16px;" 
										id="edited-electrical_upload_file">
											<div class='input-group date'>
										...
										<div class="form-group" style="margin: 30px 0 25px 16px;">
											<div class='input-group date'>
											  ...
											  <input class="form-control" id="other_certificate_file" value=""  name="other_certificate_file[]" type="file" multiple="multiple" 
											  onchange="uploadothercertfile(this.files[0],'electrical_upload_file','other_certificate_file')" /> 
											</div>
							...
							<div class="panel-body">
								...
								<div class="prev_detail_hide2" style="<?php echo $style; ?>">
									...
									<div class="form-group" style="margin: 15px 0 15px 16px;">
									   <div class='input-group date'>
										 <label>Upload Certificate</label>
										<input id="file_two" type="file" name="emergency_upload_file"  class="form-control"  <?php echo $required; ?> onchange="uploadcertfile(this.files[0],'emergency_upload_file','file_two')">
									   </div>
									   <div id="uploaded-emergency_upload_file"></div>
									</div>
									<?php if(isset($emergency_certificate_file) && !empty($emergency_certificate_file)) { ?>
									<div class="form-group" style="margin: 30px 0 25px 16px;" id="edited-emergency_upload_file">
										<div class='input-group date'>
									...
									<div class="form-group" style="margin: 30px 0 25px 16px;">
										<div class='input-group date'>
										   <label>Other Certificate File</label>
										  <input class="form-control" id="other_emergency_certificate_file" value=""  name="other_emergency_certificate_file[]" type="file" multiple="multiple" 
										   onchange="uploadothercertfile(this.files[0],'emergency_upload_file','other_emergency_certificate_file')"/> 
										</div>
									   ...
									   <!--date-img col-->
										...
										if(isset($portable_certificate_file) && !empty($portable_certificate_file)){
										 ...
										 <div class="form-group" style="margin: 15px 0 15px 16px;">
										   <div class='input-group date'>
											 <label>Upload Certificate</label>
											 <input id="file_three" type="file" name="portable_upload_file"  class="form-control" <?php echo $required; ?> onchange="uploadcertfile(this.files[0],'portable_upload_file','file_three')">
										   </div>
										    <div id="uploaded-portable_upload_file"></div>
										</div>
										
										<?php if(isset($portable_certificate_file) && !empty($portable_certificate_file)) { ?>
										<div class="form-group" style="margin: 30px 0 25px 16px;" id="edited-portable_upload_file">
												<div class='input-group date'>
										   ...
										   <!--date-img col-->
											...
											<?php $required='required="required"';
											 ...
											 <div class="form-group" style="margin: 15px 0 15px 16px;">
											   <div class='input-group date'>
													<label>Upload Certificate</label>
												   <input id="file_four" type="file" name="fire_upload_file"  class="form-control" <?php echo $required; ?> onchange="uploadcertfile(this.files[0],'fire_upload_file','file_four')">
											   </div>
											   <div id="uploaded-fire_upload_file"></div>
											</div>
												
											<?php if(isset($fire_certificate_file) && !empty($fire_certificate_file)) { ?>
											<div class="form-group" style="margin: 30px 0 25px 16px;" id="edited-fire_upload_file">
												<div class='input-group date'>
										   ...
										   <div class="card-block">
											...
											<?php $required='required="required"';
											 ...
											 <div class="form-group">
												<div class='input-group date'>
													<label>Upload Certificate</label>
												   <input id="file" type="file" name="smoke_upload_file"  class="form-control" <?php echo $required; ?>  onchange="uploadcertfile(this.files[0],'smoke_upload_file','file')">
												</div>
												<div id="uploaded-smoke_upload_file"></div>
											</div>
											
											<?php if(isset($smoke_certificate_file) && !empty($smoke_certificate_file)) { ?>
											<div class="form-group" style="margin: 30px 0 25px 16px;" id="edited-smoke_upload_file">
													<div class='input-group date'>
											...
											<div class="form-group" style="margin: 30px 0 25px 0;">
												<div class='input-group date'>
												   <label>Other Certificate File</label>
												  <input class="form-control" id="other_smoke_certificate_file" value=""  name="other_smoke_certificate_file[]" type="file" multiple="multiple"onchange="uploadothercertfile(this.files[0],'smoke_upload_file','other_smoke_certificate_file')"/> 
												</div>
										   ...
										   <!--date-img col-->
											...
											<?php $required='required="required"';
											 ...
											 <div class="form-group" style="margin: 15px 0 15px 16px;">
												<div class='input-group date'>
													<label>Upload Certificate</label>
													 <input id="file_six" type="file" name="carbon_upload_file"  class="form-control" <?php echo $required; ?> onchange="uploadcertfile(this.files[0],'carbon_upload_file','file_six')">		
												</div>
										   ...
										   <!--date-img col-->
											...
											<?php $required='required="required"';
											 ...
											 <div class="form-group" style="margin: 15px 0 15px 16px;">
												<div class='input-group date'>
													<label>Upload Certificate</label>
													 <input id="file_seven" type="file" name="gas_safety_upload"  class="form-control" <?php echo $required; ?> onchange="uploadcertfile(this.files[0],'gas_safety_upload','file_seven')">				
												</div>
												<div id="uploaded-gas_safety_upload"></div>
											</div>
											
											 <?php if(isset($gas_certificate_file) && !empty($gas_certificate_file)) { ?>
											<div class="form-group" style="margin: 30px 0 25px 16px;" id="edited-gas_safety_upload">
													<div class='input-group date'>
											...
											<div class="form-group" style="margin: 30px 0 25px 16px;">
												<div class='input-group date'>
												   <label>Other Certificate File</label>
												  <input class="form-control" id="other_gassafety_certificate_file" value=""  name="other_gassafety_certificate_file[]" type="file" 
												  multiple="multiple" onchange="uploadothercertfile(this.files[0],'gas_safety_upload','other_gassafety_certificate_file')"/> 
												</div>
