...
<div class="page-content">
   <div class="container-fluid">
      <div class="box-typical box-typical-padding">
        <h5 class="m-t-lg with-border">All properties</h5>
        <div class="row">
					<div class="col-lg-12">		
                        ...
                        <?php $i=1; foreach($property_data as $data){ ?>
                          ...
                          <tr>
                            ...
                            <td><?php echo $data['created'];?></td>
                               ...
                               <a href="<?php echo base_url() ?>jobs/upload_certificate/<?php echo $data['unique_id']; ?>">
                               ...
                               <a href="" class="del_prop swal-btn-warning " id="<?php echo $data['unique_id']; ?>"  pid="<?php echo $data['id'];?>" title="Delete Property">
