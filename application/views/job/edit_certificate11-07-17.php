			...
			<div class="row">
					...
					<div class="col-lg-12">
						<fieldset class="form-group">
							...
							<div class="input-group date">
									<input class="form-control datepicker" name="certificate_date" id="daterange3" placeholder="" value="<?php echo date('d/m/y',strtotime($all_certificate['certificate_date']))?>" type="text">
					...
					<div class="col-lg-12">
						<fieldset class="form-group">
							...
							<input class="form-control" id="exampleInputPassword1" value=""  name="certificate_file[]"  type="file" multiple="multiple"> 
							<?php echo form_error('certificate_file'); ?>
							
						</fieldset>
						<?php foreach ($all_certificate_files as $cert_file) { ?>
							
						<?php  if($cert_file['certificate_file']) { ?>
						<div class="alert alert-success fade in">
	                      <a href="#" class="close"  id="<?php echo $cert_file['certificate_unique_id'] ?>">&times;</a>
	                   <a href="<?php echo base_url() ?>uploads/cert/<?php echo $cert_file['certificate_file'] ?>" title="View file"><?php echo $cert_file['certificate_file'] ?></a>
                     </div>
                     <?php }  
                     	}
                     ?>
        ...
        function(){
           ...
           $.ajax({
                ...
                success:function(result){
                   if(result=='deleted'){
                       window.location.href='<?php echo base_url() ?>jobs/edit_certificate/<?php echo $this->uri->segment(3); ?>/'+job_id;
