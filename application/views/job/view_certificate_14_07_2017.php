            ...
            <tbody>
             ...
             <?php $i=1; foreach($all_certificates as $all_certificate){ ?> 
              ...
              <tr>
                ...
                <div class="dropdown">
                <a href="<?php echo base_url("jobs/certificate_zip/".$all_certificate['property_id']."/".$all_certificate['certificate_type']."/".$all_certificate['job_id']) ?>" class="tabledit-edit-button btn btn-sm btn-primary" title="Download"><span class="glyphicon glyphicon-download-alt"></span></a>
