            ...
            <tbody>
			 ...
			 ?> 
              ...
              <tr>
                ...
                <div class="dropdown">
                <a href="" class="tabledit-edit-button btn btn-sm btn-primary" title="Download"><span class="glyphicon glyphicon-download-alt"></span></a>
                 ...
                 <?php if(!empty($all_certificate['certificate_file'] )) { ?>                    
                  ...
                  <?php } ?>  
					     ...
					     <?php if(isset($all_certificate['job_id'])) { ?>
                 <?php if($all_certificate['count_other_cert_files'] < 6){ ?>
                 <?php $j=1; foreach ($all_certificate['other_files'] as $other_file) { ?>
                  	<a href="<?php echo base_url("jobs/other_certificate_download/".$other_file['unique_id']."/".$all_certificate['job_id']) ?>" title="Download"><?php echo $other_file['certificate_name'],' ',$j ?>
