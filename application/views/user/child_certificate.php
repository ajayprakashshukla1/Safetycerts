...
.statistic-box.active {
    ...
    <div class="page-content">
		...
		<?php $i=1; $validd = ''; $expiringd = ''; $expiredd = ''; $valid = 0; $expire = 0; $exp_soon=0;	
           ...
           <div class="row">
				 <a class="col-sm-3" href="<?php echo base_url()?>user/child_certificate/valid">
                ...
                <!--  -->
				<a class="col-sm-3" href="<?php echo base_url()?>user/child_certificate/exp_soon">
                    ...
                    <!--  -->
                	<a class="col-sm-3" href="<?php echo base_url()?>user/child_certificate/expired">
               ...
               <!--  -->
               <a class="col-sm-3" href="<?php echo base_url()?>user/child_certificate/pending_status">
