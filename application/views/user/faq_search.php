                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="faq-page-cat">
                                <div class="faq-page-cat-icon"><img src="<?php echo base_url(); ?>assest/img/faq-1.png" alt=""></div>
                        ...
                        <div class="col-md-4">
                            <div class="faq-page-cat">
                                <div class="faq-page-cat-icon"><img src="<?php echo base_url(); ?>assest/img/faq-2.png" alt=""></div>
                                <div class="faq-page-cat-title">
                        ...
                        <div class="col-md-4">
                            <div class="faq-page-cat">
                                <div class="faq-page-cat-icon"><img src="<?php echo base_url(); ?>assest/img/faq-3.png" alt=""></div>
                                <div class="faq-page-cat-title">
