             ...
             <?php } ?>
              ...
              ">
	            ...
	            <ul>
	                ...
	                <li><a href="<?php echo base_url() ?>user/faq_search"><span class="lbl">FAQ Search</span></a></li>
	            </ul>
	          </li>
...
">
			 ...
			 <li class="orange-red  <li class="<?php if($this->uri->segment(1)=="profile"){echo "opened";}?>
">
