...
public function get_certificate_filenames($pro_id, $cert_type){
    $this->db->select('certificate_id,certificate_unique_id,certificate_file,certificate_name,certificate_type');
    $this->db->from('certificate_files');
