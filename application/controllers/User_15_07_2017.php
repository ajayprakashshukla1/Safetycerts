...
#print_r($electrical); exit;
     ...
     @$emergency_id = $this->input->post('emergency_prev_date_id');
	  if(isset($emergency_id) && $emergency_id!="")  {                  
	       $electrical = array();	   
	       $electrical['certificate_date'] = $this->input->post('emergency_prev_date');
	       $this->user_model->update_property_certificate_date($electrical,$emergency_id);
	   }
	   
	   @$portable_appliance_id = $this->input->post('portable_prev_date_id');
	  if(isset($portable_appliance_id) && $portable_appliance_id!="")  {                  
	       $electrical = array();	   
	       $electrical['certificate_date'] = $this->input->post('portable_prev_date');
	       $this->user_model->update_property_certificate_date($electrical,$portable_appliance_id);
	   }
	   
	  @$fire_alarm_id = $this->input->post('fire_prev_date_id');
	  if(isset($fire_alarm_id) && $fire_alarm_id!="")  {                  
	       $electrical = array();	   
	       $electrical['certificate_date'] = $this->input->post('fire_prev_date');
	       $this->user_model->update_property_certificate_date($electrical,$fire_alarm_id);
	   }
	   
	    @$smoke_detector_id = $this->input->post('smoke_prev_date_id');
	  if(isset($smoke_detector_id) && $smoke_detector_id!="")  {                  
	       $electrical = array();	   
	       $electrical['certificate_date'] = $this->input->post('smoke_prev_date');
	       $this->user_model->update_property_certificate_date($electrical,$smoke_detector_id);
	   }
	   
	       @$carbon_monoxide_id = $this->input->post('carbon_prev_date_id');
	  if(isset($carbon_monoxide_id) && $carbon_monoxide_id!="")  {                  
	       $electrical = array();	   
	       $electrical['certificate_date'] = $this->input->post('carbon_prev_date');
	       $this->user_model->update_property_certificate_date($electrical,$carbon_monoxide_id);
	   }
	   
	        @$gas_safety_id = $this->input->post('gas_prev_date_id');
	  if(isset($gas_safety_id) && $gas_safety_id!="")  {                  
	       $electrical = array();	   
	       $electrical['certificate_date'] = $this->input->post('gas_safety_prev_date');
	       $this->user_model->update_property_certificate_date($electrical,$gas_safety_id);
	   }
