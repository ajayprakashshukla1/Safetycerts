  ...
  public function createproperty(){   
      ...
      if($certificate_data['emergency_test']=='yes'){
       // for ($j=0; $j <count($files['emergency_upload_file']['name']) ; $j++) { 
          ...
          for ($j=0; $j <count($files['other_emergency_certificate_file']['name']) ; $j++) {
				  if(!empty($files['other_emergency_certificate_file']['name'][$j])){
                ...
                $filename= time()."_".$files['other_emergency_certificate_file']['name'][$j];
                $pathfilename =  $_SERVER['DOCUMENT_ROOT']."/safetycerts/uploads/cert/".$filename;
                if(move_uploaded_file($files['other_emergency_certificate_file']['tmp_name'][$j],$pathfilename)){                
                   $data=array();
                   $other_files['other_certificate_file'] = $filename;
                   $pro= $this->db->insert('other_certificate_files', $other_files);
                }
      ...
      if($certificate_data['portable_test']=='yes'){
       ...
       for ($j=0; $j <count($files['other_portable_certificate_file']['name']) ; $j++) {
              if(!empty($files['other_portable_certificate_file']['name'][$j])){
                ...
                $filename= time()."_".$files['other_portable_certificate_file']['name'][$j];
                $pathfilename =  $_SERVER['DOCUMENT_ROOT']."/safetycerts/uploads/cert/".$filename;
                if(move_uploaded_file($files['other_portable_certificate_file']['tmp_name'][$j],$pathfilename)){                
                   $data=array();
                   $other_files['other_certificate_file'] = $filename;
                   $pro= $this->db->insert('other_certificate_files', $other_files);
                }
      ...
      if($certificate_data['fire_test']=='yes'){
		...
		for ($j=0; $j <count($files['other_fire_certificate_file']['name']) ; $j++) {
              if(!empty($files['other_fire_certificate_file']['name'][$j])){
                ...
                $filename= time()."_".$files['other_fire_certificate_file']['name'][$j];
                $pathfilename =  $_SERVER['DOCUMENT_ROOT']."/safetycerts/uploads/cert/".$filename;
                if(move_uploaded_file($files['other_fire_certificate_file']['tmp_name'][$j],$pathfilename)){                
                   $data=array();
                   $other_files['other_certificate_file'] = $filename;
                   $pro= $this->db->insert('other_certificate_files', $other_files);
                }
      ...
      if($certificate_data['smoke_test']=='yes'){
       ...
       for ($j=0; $j <count($files['other_smoke_certificate_file']['name']) ; $j++) {
              if(!empty($files['other_smoke_certificate_file']['name'][$j])){
                ...
                $filename= time()."_".$files['other_smoke_certificate_file']['name'][$j];
                $pathfilename =  $_SERVER['DOCUMENT_ROOT']."/safetycerts/uploads/cert/".$filename;
                if(move_uploaded_file($files['other_smoke_certificate_file']['tmp_name'][$j],$pathfilename)){                
                   $data=array();
                   $other_files['other_certificate_file'] = $filename;
                   $pro= $this->db->insert('other_certificate_files', $other_files);
                }
      ...
      if($certificate_data['carbon_test']=='yes'){
       ...
       for ($j=0; $j <count($files['other_carbon_certificate_file']['name']) ; $j++) {
              if(!empty($files['other_carbon_certificate_file']['name'][$j])){
                ...
                $filename= time()."_".$files['other_carbon_certificate_file']['name'][$j];
                $pathfilename =  $_SERVER['DOCUMENT_ROOT']."/safetycerts/uploads/cert/".$filename;
                if(move_uploaded_file($files['other_carbon_certificate_file']['tmp_name'][$j],$pathfilename)){                
                   $data=array();
                   $other_files['other_certificate_file'] = $filename;
                   $pro= $this->db->insert('other_certificate_files', $other_files);
                }
      ...
      if($certificate_data['gas_safety_test']=='yes'){
       ...
       for ($j=0; $j <count($files['other_gassafety_certificate_file']['name']) ; $j++) {
              if(!empty($files['other_gassafety_certificate_file']['name'][$j])){
                ...
                $filename= time()."_".$files['other_gassafety_certificate_file']['name'][$j];
                $pathfilename =  $_SERVER['DOCUMENT_ROOT']."/safetycerts/uploads/cert/".$filename;
                if(move_uploaded_file($files['other_gassafety_certificate_file']['tmp_name'][$j],$pathfilename)){                
                   $data=array();
                   $other_files['other_certificate_file'] = $filename;
                   $pro= $this->db->insert('other_certificate_files', $other_files);
                }
	   ...
	   if($certificate_data['fire_test']=='yes'){
		  ...
		  for ($j=0; $j <count($files['other_fire_certificate_file']['name']) ; $j++) {
              if(!empty($files['other_fire_certificate_file']['name'][$j])){
                ...
                $other_files['certificate_uploadedby'] = $id;
                $other_files['certificate_expire'] = $certificate_data['fire_expire'];
				$cert_data['is_first_property_certificate']= $certificate_data['is_first_property_certificate_fire'];
...
public function delete_otherCertificateAjax(){
  $post=$this->input->post();
  $post['other_certificate_file']= NULL;
  $certificate_unique_id= $this->input->post('certificate_unique_id');
  $this->db->where('certificate_unique_id', $certificate_unique_id);
  $this->db->update('other_certificate_files',$post);
   echo "updated";
}
