   ...
   */
	...
	*/
	...
	public function edit(){
		$unique_id=$_REQUEST['uniqueid'];
		$jobid=$_REQUEST['jobid'];
		$assignedjobs=$this->assignjob_model->get_assigned_jobs($unique_id,$jobid);
		$propertyid=$this->assignjob_model->get_property_unique_id($assignedjobs['job_prop_id']);
		$returnedstring=$propertyid['unique_id'];
		$returnedstring.="/".$assignedjobs['certficate_id'];
		echo json_encode($returnedstring);
	}
	...
	public function save_edit_data(){
		$post['job_prop_id']=$_REQUEST['job_prop_id'];
		$post['created_date']=date('Y-m-d h:i:s');
		$post['certificate_id']=json_encode($_REQUEST['certificate_id']);
		$post['job_id']=$_REQUEST['job_id'];
		$job_id=$this->assignjob_model->edit_job($post); 
		echo $post['job_id'];
	}
	...
	public function delete_job(){
      ...
      $this->db->where('job_id', $unique_id);
      $this->db->delete('assign_jobs'); 
      echo "deleted";
	}
